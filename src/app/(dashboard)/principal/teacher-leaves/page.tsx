...
import { FileQuestion, Check, X, Calendar, User, FileText } from "lucide-react";
...
export default function PrincipalTeacherLeavesPage() {
  ...
  const handleAction = async () => {
    ...
    try {
      const res = await fetch(`/api/leave-requests/teacher/${selectedLeave}`, {
        method: "PATCH",
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        ...
                        <CardDescription>{leave.teacher.user.email}</CardDescription>
                      </div>
